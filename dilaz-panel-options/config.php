...
# Option parameters
$parameters = array(
	'option_name'      => 'dilaz_demo_plugin_options', # must be unique. Used to save settings.
	'option_prefix'    => 'dilaz_demo_plugin_panel', # must be unique. Not used to save settings.
	...
	'page_title'       => __('Dilaz Demo Plugin Panel', 'dilaz-panel'), # The text to be displayed in the title tags of the page when the menu is selected.
	'menu_title'       => __('Dilaz Demo Plugin Panel', 'dilaz-panel'), # The text to be used for the menu.
